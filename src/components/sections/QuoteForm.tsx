...
export default function QuoteForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const apiResponse = await fetch("/api/quote-request", {
        method: "POST",
        ...
        body: JSON.stringify({
          ...
          generatedQuote: cruiseResult ? JSON.stringify({
            route: cruiseResult.route.name,
            totalPrice: cruiseResult.totalPrice,
            pricePerPerson: cruiseResult.pricePerPerson,
          }) : aiItinerary ? JSON.stringify(aiItinerary) : undefined,
          language: locale,
        }),
      });
      ...
      if (!apiResult.success) {
        console.warn("Failed to save quote to database:", apiResult.error);
      }
